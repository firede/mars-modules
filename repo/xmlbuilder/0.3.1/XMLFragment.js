(function() {
  ...
  XMLFragment = (function() {
    ...
    XMLFragment.prototype.text = function(value) {
      var child;
      if (!(value != null)) throw new Error("Missing element text");
      value = '' + value || '';
    ...
    XMLFragment.prototype.cdata = function(value) {
      var child;
      if (!(value != null)) throw new Error("Missing CDATA text");
      value = '' + value || '';
      this.assertLegalChar(value);
      if (value.match(/]]>/)) throw new Error("Invalid CDATA text: " + value);
    ...
    XMLFragment.prototype.comment = function(value) {
      var child;
      if (!(value != null)) throw new Error("Missing comment text");
      value = '' + value || '';
      value = this.escape(value);
      this.assertLegalChar(value);
      if (value.match(/--/)) {
    ...
    XMLFragment.prototype.raw = function(value) {
      var child;
      if (!(value != null)) throw new Error("Missing raw text");
      value = '' + value || '';
      child = new XMLFragment(this, '', {}, value);
      this.children.push(child);
      return this;
    ...
    XMLFragment.prototype.prev = function() {
      ...
      i = this.parent.children.indexOf(this);
      if (i < 1) throw new Error("Already at the first node");
    ...
    XMLFragment.prototype.attribute = function(name, value) {
      if (!(name != null)) throw new Error("Missing attribute name");
